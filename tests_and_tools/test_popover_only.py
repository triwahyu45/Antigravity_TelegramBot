...
def switch_model_popover(target_kw):
    ...
    (async function() {{
        ...
        // Exclude chat content containers
        ...
        if (!match) {{
            document.body.click();
            return 'POPOVER_NOT_FOUND:' + kw + ' (Current: ' + beforeModel + ')';
        }}
        ...
        return 'OK:' + afterModel + ' (Target: ' + clickedName + ')';
    }})()
    """
...
if __name__ == "__main__":
    ...
    print(f"Testing switch to '{kw}' excluding chat prose...")
    res = switch_model_popover(kw)
    print("Result:", res)
