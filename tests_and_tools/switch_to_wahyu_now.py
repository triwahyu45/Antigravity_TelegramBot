...
def switch_now():
    ...
    print(f"Switching back to Wahyu's PC at ({wahyu_x}, {wahyu_y})...")
    ...
    img.save(r"C:\Users\Triwahyu45\.gemini\antigravity\brain\2f289acc-06bd-4e56-b2d3-964240c95268\switched_now_proof.png")
