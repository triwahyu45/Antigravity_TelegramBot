...
(async function() {
    ...
    // Method: split by \\n and insert via execCommand insertText line by line with Shift+Enter KeyboardEvent or insertLineBreak
    ...
    var resText = input.innerText || input.textContent;
    return JSON.stringify({
        rawHTML: input.innerHTML,
        innerText: resText,
        hasNewline: resText.includes('\\n')
    });
})()
"""
...
if res and 'result' in res and 'result' in res['result']:
    print("COMPARISON_RESULT:", res['result']['result'].get('value'))
