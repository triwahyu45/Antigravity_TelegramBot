...
def do_deferred_switch():
    ...
    print(f"Deferred Switch: Clicking Wahyu's PC at ({wahyu_x}, {wahyu_y})...")
    ...
    img.save(r"C:\Users\Triwahyu45\.gemini\antigravity\brain\2f289acc-06bd-4e56-b2d3-964240c95268\deferred_nav_proof.png")
