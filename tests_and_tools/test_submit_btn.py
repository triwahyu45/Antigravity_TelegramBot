...
(function() {
    ...
    // Find prompt bar container
    var container = input.closest('form, div.relative, div.border') || input.parentElement.parentElement;
    var submitBtn = container ? container.querySelector('button') : null;
    
    // Alternatively look for arrow button
    var allBtns = Array.from(document.querySelectorAll('button'));
    var arrowBtn = allBtns.find(b => b.querySelector('svg') && b.offsetParent !== null && container && container.contains(b));
    
    return JSON.stringify({
        inputPresent: !!input,
        containerFound: !!container,
        submitBtnFound: !!submitBtn,
        submitBtnClass: submitBtn ? submitBtn.className : '',
        arrowBtnFound: !!arrowBtn,
        arrowBtnClass: arrowBtn ? arrowBtn.className : ''
    });
})()
"""

res = cdp_send("Runtime.evaluate", {"expression": js_test, "returnByValue": True})
print("Submit button test:", res)
