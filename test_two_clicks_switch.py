...
def test_two_clicks():
    ...
    print(f"Click 1 at ({wahyu_x}, {wahyu_y})")
    ...
    print(f"Click 2 at ({wahyu_x}, {wahyu_y})")
    user32.SetCursorPos(wahyu_x, wahyu_y)
    time.sleep(0.1)
    user32.mouse_event(0x0002, 0, 0, 0, 0)
    time.sleep(0.05)
    ...
    img_after.save(r"C:\Users\Triwahyu45\.gemini\antigravity\brain\2f289acc-06bd-4e56-b2d3-964240c95268\demo_two_clicks_result.png")
    print("Two clicks test completed!")
