...
(function() {
    ...
    for (var el of all) {
        if (el.children.length === 0 && el.innerText) {
            ...
            if (txt.startsWith('Edited') || txt.startsWith('Ran') || txt.startsWith('Running') || txt.startsWith('Explored') || txt.startsWith('Thought for') || txt.startsWith('Worked for')) {
                progressItems.push({
                    tag: el.tagName,
    ...
    return JSON.stringify(progressItems);
})()
"""
