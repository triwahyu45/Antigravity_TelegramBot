...
(function() {
    ...
    for (var i = 0; i < 5; i++) {
        ...
        var btns = curr.querySelectorAll('button, div[role="button"], svg');
        ancestors.push({level: i, tag: curr.tagName, cls: curr.className.substring(0,40), btnCount: btns.length});
    }
